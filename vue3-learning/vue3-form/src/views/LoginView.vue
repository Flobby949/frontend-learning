    ...
    <div class="flex justify-center h-screen">
      ...
      >
        <div class="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
          <div>
            <h2 class="text-4xl font-bold text-white">Tailwind CSS</h2>
            <p class="max-w-xl mt-3 text-gray-300">
              Tailwind CSS 是一个功能类优先的 CSS 框架，它集成了诸如 flex, pt-4,
              text-center 和 rotate-90
      ...
      <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
        <div class="flex-1">
          <div class="text-center">
            ...
            <p class="mt-3 text-gray-500 dark:text-gray-300">登录你的账号</p>
          </div>
          ...
          <div class="mt-8">
            ...
            <p class="mt-6 text-sm text-center text-gray-400">
              ...
              <a
                href="#"
                class="text-cyan-500 focus:outline-none focus:underline hover:underline"
                >去注册</a
              >.
            </p>
          </div>
